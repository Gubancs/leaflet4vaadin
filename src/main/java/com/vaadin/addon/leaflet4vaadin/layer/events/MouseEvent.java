...
public class MouseEvent extends LeafletEvent {
    ...
    public MouseEvent(Layer layer, MouseEventType eventType, LatLng latLng, Point layerPoint, Point containerPoint) {
    ...
    /**
     * Pixel coordinates of the point where the mouse event occured relative to the
     * map layer.
     * 
